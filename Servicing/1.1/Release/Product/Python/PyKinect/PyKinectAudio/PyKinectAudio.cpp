...
typedef HRESULT  (__stdcall _GetKinectDeviceInfo)(PKINECT_AUDIO_INFO pDeviceInfo, int *piDeviceCount);
...
extern "C" {
	__declspec(dllexport) HRESULT OpenKinectAudio(IMediaObject** ppDMO) {
		IMediaObject* pDMO;
		HRESULT hr = CoCreateInstance(CLSID_CMSRKinectAudio, NULL, CLSCTX_INPROC_SERVER, IID_IMediaObject, (void**)&pDMO);
