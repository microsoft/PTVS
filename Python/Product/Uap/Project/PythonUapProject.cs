...
namespace Microsoft.PythonTools.Uap.Project {
    ...
    partial class PythonUapProject :
        FlavoredProjectBase,
        IOleCommandTarget,
        ...
        public PythonUapProject() {
        }

        internal PythonUapPackage Package {
            get { return _package; }
            set {
                Debug.Assert(_package == null);
                if (_package != null) {
                    throw new InvalidOperationException("PythonUapProject.Package must only be set once");
                }
                _package = value;
            }
        }
        ...
        protected override void SetInnerProject(IntPtr innerIUnknown) {
            ...
            if (_menuService == null) {
                throw new InvalidOperationException("Cannot initialize Uap project");
            }
        }
        ...
        private static Guid[] CfgSpecificPropertyPagesToAdd = new Guid[] {
            new Guid(GuidList.guidUapPropertyPageString)
        };
        ...
        public int CreateProjectFlavorCfg(IVsCfg pBaseProjectCfg, out IVsProjectFlavorCfg ppFlavorCfg) {
            ...
            ppFlavorCfg = new PythonUapProjectConfig(pBaseProjectCfg, uapCfg);
            return VSConstants.S_OK;
        }
