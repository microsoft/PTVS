...
namespace Microsoft.PythonTools.Uap.Project {
    ...
    class PythonUapProjectConfig :
        ...
        private readonly IVsProjectFlavorCfg _uapCfg;
        ...
        private async System.Threading.Tasks.Task RemoteProcessAttachAsync(string remoteMachine, string secret, string port, string sourceDir, string targetDir) {
            ...
            var qualifierString = string.Format(
                ...
                HttpUtility.UrlEncode(AD7Engine.TargetUap));
        ...
        public int EnumOutputs(out IVsEnumOutputs ppIVsEnumOutputs) {
            IVsProjectCfg projCfg = _uapCfg as IVsProjectCfg;
            if (projCfg != null) {
        ...
        public int get_CfgType(ref Guid iidCfg, out IntPtr ppCfg) {
            ...
            var projCfg = _uapCfg as IVsProjectFlavorCfg;
            if (projCfg != null) {
        ...
        public int Close() {
            IVsProjectFlavorCfg cfg = _uapCfg as IVsProjectFlavorCfg;
            if (cfg != null) {
                return cfg.Close();
            }
            return VSConstants.S_OK;
