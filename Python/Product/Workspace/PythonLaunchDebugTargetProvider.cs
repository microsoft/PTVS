...
namespace Microsoft.PythonTools.Workspace {
    [ExportLaunchConfigurationProvider(
        ...
        PythonDebugLaunchProvider.LaunchTypeName,
        PythonDebugLaunchProvider.JsonSchema
    )]
    class PythonLaunchDebugTargetProvider : ILaunchConfigurationProvider {
        ...
        public void CustomizeLaunchConfiguration(DebugLaunchActionContext debugLaunchActionContext, IPropertySettings launchSettings) {
            launchSettings[PythonDebugLaunchProvider.InterpreterKey] = "(default)";
            launchSettings[PythonDebugLaunchProvider.InterpreterArgumentsKey] = string.Empty;
            launchSettings[PythonDebugLaunchProvider.ScriptArgumentsKey] = string.Empty;
            launchSettings[PythonDebugLaunchProvider.NativeDebuggingKey] = false;
        }
    }
}
