...
class Block(PandasObject):
    ...
    def interpolate(self, method: str = ..., axis: int = ..., index = ..., values = ..., inplace: bool = ..., limit = ..., limit_direction: str = ..., limit_area = ..., fill_value = ..., coerce: bool = ..., downcast = ..., **kwargs): ...
...
class FloatBlock(FloatOrComplexBlock):
    is_float: bool = ...
    def to_native_types(self, slicer = ..., na_rep: str = ..., float_format = ..., decimal: str = ..., quoting = ..., **kwargs): ...
    def should_store(self, value): ...
...
class TimeDeltaBlock(DatetimeLikeBlockMixin, IntBlock):
    ...
    def should_store(self, value): ...
    def to_native_types(self, slicer = ..., na_rep = ..., quoting = ..., **kwargs): ...
    def external_values(self, dtype = ...): ...
    def array_values(self) -> ExtensionArray: ...
