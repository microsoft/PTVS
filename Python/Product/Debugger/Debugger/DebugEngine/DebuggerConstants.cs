...
{
	internal class DebuggerConstants
	{
		...
		private static Guid _guidFilterRegisters = new Guid("223ae797-bd09-4f28-8241-2763bdc5f713");
		public static Guid guidFilterRegisters => _guidFilterRegisters;

		private static Guid _guidFilterLocals = new Guid("b200f725-e725-4c53-b36a-1ec27aef12ef");
		public static Guid guidFilterLocals => _guidFilterLocals;

		private static Guid _guidFilterAllLocals = new Guid("196db21f-5f22-45a9-b5a3-32cddb30db06");
		public static Guid guidFilterAllLocals => _guidFilterAllLocals;

		private static Guid _guidFilterArgs = new Guid("804bccea-0475-4ae7-8a46-1862688ab863");
		public static Guid guidFilterArgs => _guidFilterArgs;

		private static Guid _guidFilterLocalsPlusArgs = new Guid("e74721bb-10c0-40f5-807f-920d37f95419");
		public static Guid guidFilterLocalsPlusArgs => _guidFilterLocalsPlusArgs;

		private static Guid _guidFilterAllLocalsPlusArgs = new Guid("939729a8-4cb0-4647-9831-7ff465240d5f");
		public static Guid guidFilterAllLocalsPlusArgs => _guidFilterAllLocalsPlusArgs;

		// Language guid for Python. Used when the language for a document context or a stack frame is requested.
		private static Guid _guidLanguagePython = new Guid("DA3C7D59-F9E4-4697-BEE7-3A0703AF6BFF");
		public static Guid guidLanguagePython => _guidLanguagePython;

		// Language guid for Python. Used when the language for a document context or a stack frame is requested.
		private static Guid _guidLanguageDjangoTemplate = new Guid("918E5764-7026-4D57-918D-19D86AD73AC4");
		public static Guid guidLanguageDjangoTemplate => _guidLanguageDjangoTemplate;

		public static Guid guidLocalPortSupplier { get; } = new Guid("708C1ECA-FF48-11D2-904F-00C04FA302A1");
	...
	internal static class DebuggerLanguageNames
	{
