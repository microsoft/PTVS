...
namespace Microsoft.PythonTools.Commands {
    ...
    internal class AzureExplorerAttachDebuggerCommand : Command {
        ...
        private async Task<XDocument> GetPublishXml(AzureWebSiteInfo webSiteInfo) {
            ...
            var webSiteServices = (IVsAzureServices)PythonToolsPackage.GetGlobalService(typeof(IVsAzureServices));
            ...
            string requestPath = string.Format(
                ...
                webSite.WebSpace,
                webSite.Name);
            var requestUri = new Uri(subscription.ServiceManagementEndpointUri, requestPath);
