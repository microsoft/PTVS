...
namespace Microsoft.PythonTools.Options {
    public sealed class GeneralOptions{
        ...
        private const string MismatchedEncodingWarningSetting = "MismatchedEncodingWarning";
        ...
        public void Load() {
            ...
            MismatchedEncodingWarning = _pyService.LoadBool(MismatchedEncodingWarningSetting, GeneralCategory) ?? true;
        ...
        public bool MismatchedEncodingWarning {
            get;
            set;
        }
    }
