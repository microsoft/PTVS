...
namespace Microsoft.PythonTools.Options {
    public partial class PythonAdvancedEditorOptionsControl : UserControl {
        ...
        internal void SyncPageWithControlSettings(PythonToolsService pyService) {
            pyService.AdvancedEditorOptions.AutoImportCompletions = _autoImportCompletions.Checked;
            pyService.AdvancedEditorOptions.CompleteFunctionParens = _completeFunctionParens.Checked;
        }
    }
}
