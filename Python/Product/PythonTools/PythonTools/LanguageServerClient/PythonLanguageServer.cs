...
namespace Microsoft.PythonTools.LanguageServerClient {
    internal abstract class PythonLanguageServer {
        public static PythonLanguageServer Create(IServiceProvider site, PythonLanguageVersion version) {
            if (PythonLanguageServerNodejs.IsPreferred(version)) {
                return new PythonLanguageServerNodejs(site);
            }

            return new PythonLanguageServerDotNetCore(site);
        }
