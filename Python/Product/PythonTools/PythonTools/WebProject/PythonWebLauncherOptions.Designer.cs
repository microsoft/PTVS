namespace Microsoft.PythonTools.Project.Web {
    partial class PythonWebLauncherOptions {
        ...
        private void InitializeComponent() {
            ...
            this._debugGroup.Size = new System.Drawing.Size(591, 247);
            this._debugGroup.TabIndex = 0;
            this._debugGroup.TabStop = false;
            this._debugGroup.Text = "Run";
            // 
            // tableLayoutPanel2
            // 
            ...
            this.tableLayoutPanel2.Size = new System.Drawing.Size(579, 218);
            this.tableLayoutPanel2.TabIndex = 0;
            // 
            // _environment
            // 
            this._environment.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
            this._environment.Location = new System.Drawing.Point(129, 159);
            this._environment.Margin = new System.Windows.Forms.Padding(6, 3, 6, 3);
            this._environment.MinimumSize = new System.Drawing.Size(50, 4);
            this._environment.Multiline = true;
            this._environment.Name = "_environment";
            this._environment.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
            this._environment.Size = new System.Drawing.Size(444, 56);
            this._environment.TabIndex = 13;
            this._toolTip.SetToolTip(this._environment, "Specifies environment variables to be set in the spawned process in the form:\r\n\r\n" +
        "NAME1=value1\r\nNAME2=value2\r\n...");
            ...
            this._searchPaths.Size = new System.Drawing.Size(444, 20);
            ...
            this._arguments.Size = new System.Drawing.Size(444, 20);
            ...
            this._interpArgs.Size = new System.Drawing.Size(444, 20);
        ...
        "o generate optimized byte code).");
            ...
            this._interpreterPath.Size = new System.Drawing.Size(444, 20);
        ...
        "o generate optimized byte code).");
            ...
            this._portNumberLabel.Location = new System.Drawing.Point(6, 136);
            ...
            this._portNumberLabel.TabIndex = 10;
            this._portNumberLabel.Text = "Port Nu&mber:";
            this._portNumberLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._portNumberLabel, "The port on which the development server should listen. When not specified a rand" +
        "om free port will be used. The SERVER_PORT environment variable is set to this v" +
        "alue.");
            // 
            // _portNumber
            // 
            ...
            this._portNumber.Size = new System.Drawing.Size(444, 20);
            this._portNumber.TabIndex = 11;
            this._toolTip.SetToolTip(this._portNumber, "The port on which the development server should listen. When not specified a rand" +
        "om free port will be used. The SERVER_PORT environment variable is set to this v" +
        "alue.");
            ...
            this._launchUrl.Size = new System.Drawing.Size(444, 20);
            this._launchUrl.TabIndex = 9;
            this._toolTip.SetToolTip(this._launchUrl, "The URL to open in the browser when starting the development server. When not spe" +
        "cified http://localhost will be launched.");
            ...
            this._launchUrlLabel.Location = new System.Drawing.Point(6, 110);
            ...
            this._toolTip.SetToolTip(this._launchUrlLabel, "The URL to open in the browser when starting the development server. When not spe" +
        "cified http://localhost will be launched.");
            // 
            // _environmentLabel
            // 
            this._environmentLabel.Anchor = System.Windows.Forms.AnchorStyles.Left;
            this._environmentLabel.AutoSize = true;
            this._environmentLabel.Location = new System.Drawing.Point(6, 180);
            this._environmentLabel.Margin = new System.Windows.Forms.Padding(6, 0, 6, 0);
            this._environmentLabel.Name = "_environmentLabel";
            this._environmentLabel.Size = new System.Drawing.Size(69, 13);
            this._environmentLabel.TabIndex = 12;
            this._environmentLabel.Text = "&Environment:";
            this._environmentLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._environmentLabel, "Specifies environment variables to be set in the spawned process in the form:\r\n\r\n" +
        "NAME1=value1\r\nNAME2=value2\r\n...");
            // 
            // _debugServerTarget
            // 
            ...
            this._debugServerTarget.Size = new System.Drawing.Size(320, 20);
            this._debugServerTarget.TabIndex = 1;
            this._toolTip.SetToolTip(this._debugServerTarget, "The command to run when pressing F5 or the \"Start debug server\" command. This may" +
        " be a script, module, or a single line of Python code. By default, the current s" +
        "tartup script is used.");
            ...
            this._debugServerArguments.Size = new System.Drawing.Size(486, 20);
            this._debugServerArguments.TabIndex = 4;
            this._toolTip.SetToolTip(this._debugServerArguments, "Any command line arguments to provide. This is ignored if the command type is \"co" +
        "de\".");
            ...
            this._debugServerEnvironment.Size = new System.Drawing.Size(486, 56);
            this._debugServerEnvironment.TabIndex = 6;
            this._toolTip.SetToolTip(this._debugServerEnvironment, "Environment variables to set before starting the server. Each value should appear" +
        " on its own line in \"KEY=VALUE\" format. By default, SERVER_HOST and SERVER_PORT " +
        "are set.");
            ...
            this._debugServerEnvironmentLabel.Text = "En&vironment:";
            this._debugServerEnvironmentLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._debugServerEnvironmentLabel, "Environment variables to set before starting the server. Each value should appear" +
        " on its own line in \"KEY=VALUE\" format. By default, SERVER_HOST and SERVER_PORT " +
        "are set.");
            // 
            ...
            this._debugServerArgumentsLabel.Text = "Arg&uments:";
            this._debugServerArgumentsLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._debugServerArgumentsLabel, "Any command line arguments to provide. This is ignored if the command type is \"co" +
        "de\".");
            // 
            ...
            this._debugServerTargetLabel.Text = "C&ommand:";
            this._debugServerTargetLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._debugServerTargetLabel, "The command to run when pressing F5 or the \"Start debug server\" command. This may" +
        " be a script, module, or a single line of Python code. By default, the current s" +
        "tartup script is used.");
            // 
            ...
            "module",
            "code"});
            this._debugServerTargetType.Location = new System.Drawing.Point(419, 3);
            ...
            this._debugServerTargetType.Size = new System.Drawing.Size(154, 21);
            this._debugServerTargetType.TabIndex = 2;
            this._toolTip.SetToolTip(this._debugServerTargetType, "The type of the command. If no command is specified, this value is always treated" +
        " as \"script\".");
            ...
            this._runServerTarget.Size = new System.Drawing.Size(320, 20);
            this._runServerTarget.TabIndex = 1;
            this._toolTip.SetToolTip(this._runServerTarget, "The command to run when pressing Ctrl+F5 or the \"Start server\" command. This may " +
        "be a script, module, or a single line of Python code. By default, the current st" +
        "artup script is used.");
            ...
            this._runServerArguments.Size = new System.Drawing.Size(486, 20);
            this._runServerArguments.TabIndex = 4;
            this._toolTip.SetToolTip(this._runServerArguments, "Any command line arguments to provide. This is ignored if the command type is \"co" +
        "de\".");
            ...
            this._runServerEnvironment.Size = new System.Drawing.Size(486, 56);
            this._runServerEnvironment.TabIndex = 6;
            this._toolTip.SetToolTip(this._runServerEnvironment, "Environment variables to set before starting the server. Each value should appear" +
        " on its own line in \"KEY=VALUE\" format. By default, SERVER_HOST and SERVER_PORT " +
        "are set.");
            ...
            this._runServerEnvironmentLabel.Text = "E&nvironment:";
            this._runServerEnvironmentLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._runServerEnvironmentLabel, "Environment variables to set before starting the server. Each value should appear" +
        " on its own line in \"KEY=VALUE\" format. By default, SERVER_HOST and SERVER_PORT " +
        "are set.");
            // 
            ...
            this._runServerArgumentsLabel.Text = "A&rguments:";
            this._runServerArgumentsLabel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this._toolTip.SetToolTip(this._runServerArgumentsLabel, "Any command line arguments to provide. This is ignored if the command type is \"co" +
        "de\".");
            // 
            ...
            this._toolTip.SetToolTip(this._runServerTargetLabel, "The command to run when pressing Ctrl+F5 or the \"Start server\" command. This may " +
        "be a script, module, or a single line of Python code. By default, the current st" +
        "artup script is used.");
            // 
            ...
            "module",
            "code"});
            this._runServerTargetType.Location = new System.Drawing.Point(419, 3);
            ...
            this._runServerTargetType.Size = new System.Drawing.Size(154, 21);
            this._runServerTargetType.TabIndex = 2;
            this._toolTip.SetToolTip(this._runServerTargetType, "The type of the command. If no command is specified, this value is always treated" +
        " as \"script\".");
            ...
            this.tableLayoutPanel1.Size = new System.Drawing.Size(603, 603);
            ...
            this._debugServerGroup.Location = new System.Drawing.Point(6, 431);
            ...
            this._debugServerGroup.Size = new System.Drawing.Size(591, 144);
            ...
            this.tableLayoutPanel4.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
            this.tableLayoutPanel4.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
            this.tableLayoutPanel4.Size = new System.Drawing.Size(579, 115);
            ...
            this._runServerGroup.Location = new System.Drawing.Point(6, 271);
            ...
            this._runServerGroup.Size = new System.Drawing.Size(591, 144);
            ...
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
            this.tableLayoutPanel3.Size = new System.Drawing.Size(579, 115);
            ...
            this.Size = new System.Drawing.Size(603, 603);
