...
namespace Microsoft.PythonTools {
    ...
    [ProvideDebugAdapter("VSCode Python Debugger", DebugAdapterLauncher.VSCodeDebugEngineId, DebugAdapterLauncher.DebugAdapterLauncherCLSID,  "Python", "{DA3C7D59-F9E4-4697-BEE7-3A0703AF6BFF}")]
