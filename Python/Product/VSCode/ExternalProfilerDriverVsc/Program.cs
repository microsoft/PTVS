        ...
        static void Main(string[] args)
        {
            ...
            var res = parser.ParseArguments<ProgramOptions>(args)
                            .WithParsed<ProgramOptions>( opts => {
                                ...
                                if (opts.CallStackFNameToParse != null) {  // TODO: test /tmp/results_20180314/r_stacks_0004.csv
                                ...
                                Console.WriteLine($"Reading file [{stackReportFName}].");
                                var samples = VTuneToDWJSON.ParseFromFile(stackReportFName);
