...
namespace TestAdapterTests
{
	...
	public abstract partial class TestDiscovererTests
	{
		...
		protected abstract override PythonVersion Version { get; }

		protected virtual System.String GetImportErrorFormat()
		{
			return "ModuleNotFoundError: No module named '{0}'";
		}
		...
		protected abstract MockMessageLogger logd();
		...
		private static void ValidateDiscoveredTests(string testFramework, IList<TestCase> actualTests, TestInfo[] expectedTests)
		{
			...
			foreach (TestInfo expectedTest in expectedTests)
			{
		...
		public static abstract void DoDeployment(TestContext context);
		protected abstract override System.String GetImportErrorFormat();
	}

	internal class Environment
	{
		public static global::System.Object NewLine { get; internal set; }
	}
	...
	{
		[ClassInitialize]
		public override void DoDeployment(TestContext context)
		{
