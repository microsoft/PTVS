...
namespace Microsoft.VisualStudioTools {
    internal static class Dialogs {
        ...
        public static string BrowseForFileOpen(IntPtr owner, string filter, string initialPath = null) {
        ...
        public static string BrowseForFileSave(IntPtr owner, string filter, string initialPath = null) {
            if (string.IsNullOrEmpty(initialPath)) {
                initialPath = Environment.GetFolderPath(Environment.SpecialFolder.Personal) + Path.DirectorySeparatorChar;
            }
        ...
        public static string BrowseForDirectory(IntPtr owner, string initialDirectory = null) {
            IVsUIShell uiShell = GetService(typeof(SVsUIShell)) as IVsUIShell;
            if (null == uiShell) {
