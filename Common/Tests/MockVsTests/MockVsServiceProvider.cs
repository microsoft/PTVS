...
namespace Microsoft.VisualStudioTools.MockVsTests
{
	...
	public class MockVsServiceProvider : SVsServiceProvider, IOleServiceProvider, IServiceContainer, IDisposable
	{
		...
		{
			if (_servicesByGuid.TryGetValue(serviceType, out global::System.Object res))
			{
				return res;
			}

			if (_serviceCreatorByGuid.TryGetValue(serviceType, out ServiceCreatorCallback creator))
			{
