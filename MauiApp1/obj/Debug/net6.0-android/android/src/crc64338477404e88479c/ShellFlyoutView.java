...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.Controls.Platform.ShellFlyoutView, Microsoft.Maui.Controls", ShellFlyoutView.class, __md_methods);
	}


	public ShellFlyoutView (android.content.Context p0)
	{
		super (p0);
		if (getClass () == ShellFlyoutView.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Controls.Platform.ShellFlyoutView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public ShellFlyoutView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == ShellFlyoutView.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Controls.Platform.ShellFlyoutView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public ShellFlyoutView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == ShellFlyoutView.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Controls.Platform.ShellFlyoutView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
	}
