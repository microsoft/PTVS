...
Add-Content -Path ".npmrc" -Value "//devdiv.pkgs.visualstudio.com/_packaging/Pylance/npm/registry/:_password=$Env:AZURE_DEVOPS_TOKEN"
...
Add-Content -Path ".npmrc" -Value "//devdiv.pkgs.visualstudio.com/_packaging/Pylance/npm/:_password=$Env:AZURE_DEVOPS_TOKEN"
