...
always-auth=true
; begin auth token
//devdiv.pkgs.visualstudio.com/_packaging/Pylance%40Local/npm/registry/:username=$Env:MAPPED_AZURE_DEVOPS_USERNAME
...
//devdiv.pkgs.visualstudio.com/_packaging/Pylance%40Local/npm/:username=$Env:MAPPED_AZURE_DEVOPS_USERNAME
